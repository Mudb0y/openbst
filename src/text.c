...
const bst_tabmap BST_MAP_1998_DUT = {
    ...
    .coefgain       = 0x000a07a4,
    .diph_offsets   = 0x00099fcc,
    .diph_offsets_end = 0x0009b22e,
    .diph_records   = 0x00090000,
    .dispatch       = 0x00050000,
    .exctab         = 0x000a0dcc,
...
const bst_tabmap BST_MAP_1998_GRM = {
    ...
    .coefgain       = 0x000a078c,
    .diph_offsets   = 0x00099524,
    .diph_offsets_end = 0x0009a786,
    .diph_records   = 0x00091004,
    .dispatch       = 0x00050000,
    .exctab         = 0x000a0db4,
...
const bst_tabmap BST_MAP_1998_ITL = {
    ...
    .coefgain       = 0x000a046c,
    .diph_offsets   = 0x000741de,
    .diph_offsets_end = 0x00075324,
    .diph_records   = 0x00070000,
    .dispatch       = 0x00050000,
    .exctab         = 0x000a0a94,
