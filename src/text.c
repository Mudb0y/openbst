...
const bst_tabmap BST_MAP_1998_DUT = {
    ...
    .chattr         = 0x000a1714,
    .classtab       = 0x000a0dc6,
    .code_initial   = 0x000a0276,
    .code_medial    = 0x000a020c,
    .coefgain       = 0x000a07a4,
...
const bst_tabmap BST_MAP_1998_FRN = {
    ...
    .chattr         = 0x000a13a2,
    .classtab       = 0x000a0b02,
    .code_initial   = 0x000a00ec,
    .code_medial    = 0x000a0082,
    .coefgain       = 0x000a04e0,
    ...
    .phattr2        = 0x000a0e8e,
    .rules          = 0x00030000,
    .sound_add      = 0x000a016e,
    .stress_add     = 0x000a01d0,
    .stress_num     = 0x000a01e2,
...
const bst_tabmap BST_MAP_1998_GRM = {
    ...
    .chattr         = 0x000a16ea,
    .classtab       = 0x000a0dae,
    .code_initial   = 0x000a0270,
    .code_medial    = 0x000a0206,
    .coefgain       = 0x000a078c,
...
const bst_tabmap BST_MAP_1998_ITL = {
    ...
    .chattr         = 0x000a1324,
    .classtab       = 0x000a0a8e,
    .code_initial   = 0x000a0c6e,
    .code_medial    = 0x000a0c04,
    .coefgain       = 0x000a046c,
    ...
    .phattr2        = 0x000a0e2a,
    .rules          = 0x00030000,
    .sound_add      = 0x000a0cf0,
    .stress_add     = 0x000a0d52,
    .stress_num     = 0x000a0d64,
    .suffix_ptrs    = 0x000a0bf8,
    .symmap         = 0x000a1624,
    .tokstates      = 0x000a1084,
    .trans_pitch    = 0x000a0d88,
    .trie_desc      = 0x00070000,
    .voices         = 0x00090000,
    .vowel_dur      = 0x000a0fd4,
...
const bst_tabmap BST_MAP_1998_SPN = {
    ...
    .chattr         = 0x000a12fa,
    .classtab       = 0x000a0a6c,
    .code_initial   = 0x000a00a8,
    .code_medial    = 0x000a003e,
    .coefgain       = 0x000a044a,
...
const bst_tabmap BST_MAP_2006_ARA = {
    ...
    .names             = 0x100211C0,
    .code_medial       = 0x100219D8,
    .code_initial      = 0x10021A44,
    .ph_single         = 0x1001F334,
    .ph_pair           = 0x1001F3E0,
    .suffix_ptrs       = 0x100219CC,
    ...
    .modmap            = 0x1001F94C,
    .modtab            = 0x1001F950,
    .trans_pitch       = 0x10020460,
    .vowel_dur         = 0x100206AC,
...
const bst_tabmap BST_MAP_2006_DUT = {
    ...
    .modmap            = 0x1001FD38,
    .modtab            = 0x1001FD54,
    .trans_pitch       = 0x1002EBDC,
    .vowel_dur         = 0x1002EE28,
    .stress_num        = 0x1002F078,
    .stress_add        = 0x1002F064,
...
const bst_tabmap BST_MAP_2006_FRE = {
    ...
    .names             = 0x1001FCF0,
    .code_medial       = 0x100204EC,
    .code_initial      = 0x10020550,
    ...
    .modmap            = 0x1001B214,
    .modtab            = 0x1001B218,
    .trans_pitch       = 0x1001BA84,
    .vowel_dur         = 0x1001BCD0,
...
const bst_tabmap BST_MAP_2006_GER = {
    ...
    .modmap            = 0x10021B28,
    .modtab            = 0x10021B4C,
    .trans_pitch       = 0x1002CAC8,
    .vowel_dur         = 0x1002CD14,
...
const bst_tabmap BST_MAP_2006_GRE = {
    ...
    .names             = 0x1001F764,
    .code_medial       = 0x1001FF54,
    .code_initial      = 0x1001FFC0,
    .ph_single         = 0x1001DB20,
    .ph_pair           = 0x1001DBCC,
    .suffix_ptrs       = 0x1001FF48,
    ...
    .modmap            = 0x1001E1B8,
    .modtab            = 0x1001E1BC,
    .trans_pitch       = 0x1001EA38,
    .vowel_dur         = 0x1001EC84,
...
const bst_tabmap BST_MAP_2006_HEB = {
    ...
    .names             = 0x100200CC,
    .code_medial       = 0x100208BC,
    .code_initial      = 0x10020928,
    .ph_single         = 0x1001D804,
    .ph_pair           = 0x1001D8B0,
    .suffix_ptrs       = 0x100208B0,
    ...
    .modmap            = 0x1001DE1C,
    .modtab            = 0x1001DE24,
    .trans_pitch       = 0x1001F27C,
    .vowel_dur         = 0x1001F4C8,
...
const bst_tabmap BST_MAP_2006_ITA = {
    ...
    .names             = 0x1002641C,
    .code_medial       = 0x10026C28,
    .code_initial      = 0x10026C94,
    .ph_single         = 0x10017734,
    .ph_pair           = 0x100177E0,
    .suffix_ptrs       = 0x10026C1C,
    ...
    .modmap            = 0x10017D4C,
    .modtab            = 0x10017D5C,
    .trans_pitch       = 0x1001F52C,
    .vowel_dur         = 0x1001F778,
    .stress_num        = 0x1001F958,
    .stress_add        = 0x1001F944,
...
const bst_tabmap BST_MAP_2006_JPN = {
    ...
    .names             = 0x1001AEF0,
    .code_medial       = 0x1001B708,
    .code_initial      = 0x1001B774,
    .ph_single         = 0x10016E50,
    .ph_pair           = 0x10016EFC,
    .suffix_ptrs       = 0x1001B6FC,
    ...
    .modmap            = 0x10017738,
    .modtab            = 0x1001773C,
    .trans_pitch       = 0x1001A01C,
    .vowel_dur         = 0x1001A268,
...
const bst_tabmap BST_MAP_2006_POL = {
    ...
    .names             = 0x10022D30,
    .code_medial       = 0x10023084,
    .code_initial      = 0x100230F0,
    .ph_single         = 0x1001ECB0,
    .ph_pair           = 0x1001ED5C,
    .suffix_ptrs       = 0x10023078,
    ...
    .modmap            = 0x1001F0A0,
    .modtab            = 0x1001F0B8,
    .trans_pitch       = 0x10021280,
    .vowel_dur         = 0x100214CC,
    .stress_num        = 0x10021718,
    .stress_add        = 0x10021704,
...
const bst_tabmap BST_MAP_2006_POR = {
    ...
    .names             = 0x100235A0,
    .code_medial       = 0x10023DD4,
    .code_initial      = 0x10023E38,
    ...
    .modmap            = 0x100200AC,
    .modtab            = 0x100200BC,
    .trans_pitch       = 0x10021E18,
    .vowel_dur         = 0x10022064,
...
const bst_tabmap BST_MAP_2006_RUS = {
    ...
    .basedur           = 0x1002618C,
    .coefgain          = 0x10025D88,
    .tokstates         = 0x100253B4,
    .names             = 0x10025BE8,
    .code_medial       = 0x100263E0,
    .code_initial      = 0x1002644C,
    .ph_single         = 0x10025BA4,
    .ph_pair           = 0x10025C50,
    .suffix_ptrs       = 0x100263D4,
    .patterns          = 0x100264B8,
    .modmap            = 0x100261BC,
    .modtab            = 0x100261E4,
    .diph_offsets_end  = 0x10025B24,
    .tok_stride        = 12,
    .tok_state_w       = 4,
    .tok_handler_off   = 4,
    .tok_handler_w     = 4,
...
const bst_tabmap BST_MAP_2006_SPA = {
    ...
    .names             = 0x1001A18C,
    .code_medial       = 0x1001A994,
    .code_initial      = 0x1001AA00,
    .ph_single         = 0x10017514,
    .ph_pair           = 0x100175C0,
    .suffix_ptrs       = 0x1001A988,
    ...
    .modmap            = 0x10017B2C,
    .modtab            = 0x10017B34,
    .trans_pitch       = 0x1001859C,
    .vowel_dur         = 0x100187E8,
